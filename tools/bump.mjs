...
const DIRS = ['models', 'models/characters', 'models/vehicles', 'models/weapons', 'models/buildings', 'models/towers', 'images', 'audio', 'audio/plasma_sounds', 'audio/alien_orc_grunt_sounds', 'audio/hit_sounds', 'audio/creature_noises'];
